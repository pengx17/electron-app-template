...
const paths: OutputPaths = {
  // Generate api types under @video-editor/electron-api
  apiTypes: path.resolve(rootDir, 'electron-api/src/ipc-api-types.gen.ts'),
  ipcMeta: path.resolve(electronRoot, 'src/entries/preload/ipc-meta.gen.ts'),
  // Event type definitions
  eventTypes: path.resolve(rootDir, 'electron-api/src/ipc-event-types.gen.ts'),
};
